...
const mehh = 'https://api.i-tech.id/dl/yt?key=EsaLJj-qJUG6E-O0fF9E-G61qr7-O4MS4w'
...
const yt3 = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://api.i-tech.id/dl/yt?key=EsaLJj-qJUG6E-O0fF9E-G61qr7-O4MS4w&link=${url}`)
    .then(res => {
        resolve(res.data)
    })
    .catch(err =>  {
